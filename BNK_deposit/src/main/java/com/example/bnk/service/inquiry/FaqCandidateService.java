...
//                .body(Map.class);
    ...
    public Map<String, Object> approveCandidate(Long candidateNo, String question, String answer) {
        ...
        // 4) FaQ 호출 - 
        //faqDao.insertNewFaq(question, answer);
